...
def train():
    ...
    with time_measure("[1] Data load"):
        ...
        dataset = load_dataset_split("train")
        dataset_val = load_dataset_split("val", skip=5)
    ...
    for i in trange(start, N_iters):
        ...
        if i % args.i_testset == 0 and i > 0:
            ...
            with torch.no_grad():
                ...
                # also output encoded mask
                if isinstance(label_encoder, ColoredLabelEncoder):
                    writer.add_images('test/inferred_mask_encoded', instances.transpose((0, 3, 1, 2)), i)
