...
def depth_to_normal(depth, pose, camera_angle_x):
	...
	position = depth_to_position(height, width, K, pose, depth[..., None])
...
if __name__ == "__main__":
	...
	# 	# target, i)
	depth = np.load('/home/ccw/Downloads/105943_depth_filled.npy')
	depth_to_normal(depth, np.array([
		[-0.16537469094025592, -0.10836604110218336, 0.9802591558933601, 3.79904605518636],
		[0.9814742950892837, -0.1155843777492689, 0.15280202779791419, 1.1872325197861604],
		[0.09674409374211189, 0.9873687521573762, 0.1254732145501887, 0.5940830562580642],
		[0, 0, 0, 1]
	]), 1.4837077017836913)
